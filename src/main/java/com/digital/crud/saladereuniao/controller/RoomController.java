...
public class RoomController {
    ...
    public ResponseEntity<Room> getRoomById(@PathVariable(value = "id") long roomId)
        ...
        Room room = roomRepository.findById(roomId)
                .orElseThrow(() -> new ResourceNotFoundException("Room not foundt:: " + roomId));
    ...
    @PutMapping("/rooms/{id}")
    public ResponseEntity<Room> updateRoom(@PathVariable(value = "id") long roomId, @Validated @RequestBody Room roomDetails)
            throws ResourceNotFoundException {
        Room room = roomRepository.findById(roomId)
